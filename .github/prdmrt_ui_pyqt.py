...
main_relay_status,valid_values=[0;1],메인 릴레이 상태"""
    ...
    def run_validation(self):
        ...
        try:
            ...
            validator.AWS_ACCESS_KEY_ID = AWS_ACCESS_KEY_ID
            validator.AWS_SECRET_ACCESS_KEY = AWS_SECRET_ACCESS_KEY
...
class WorkerThread(QThread):
    ...
    def _auto_bms_validation(self, base_folder, pids, pid_download_status, start_date, end_date):
        ...
        shared_validator.AWS_ACCESS_KEY_ID = AWS_ACCESS_KEY_ID
        shared_validator.AWS_SECRET_ACCESS_KEY = AWS_SECRET_ACCESS_KEY
